...
class Board:
    ...
    def engine(self, board):  # OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD
    ...
    def load_board(self, filename):  # OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD OLD
